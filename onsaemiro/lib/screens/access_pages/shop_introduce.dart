...
class shopIntroducePage extends StatefulWidget {
  ...
  shopIntroducePage(this.shop, this.products);
  @override
  _shopIntroducePageState createState() =>
      _shopIntroducePageState(this.shop, this.products);
}

class _shopIntroducePageState extends State<shopIntroducePage> {
  _shopIntroducePageState(this._shop, this._products);
  Shop _shop;
